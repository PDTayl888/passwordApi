...
app.get('/api/passinfo', (req, res) => {
  ...
  if (value == undefined) {
    ...
    console.log('VALUE.ENCRYPTED', value.encrypted);
    console.log('VALUE.PRIVATEKEY', req.body.privateKey);
    if (req.body.privateKey) {
      console.log('PRIV IF ONE');
      if (value.encrypted) {
        console.log('ENCRYPT IF TWO');
